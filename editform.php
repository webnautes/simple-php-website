...
<div class="container">
    <div>
        <h1 class="h2" align="center">&nbsp; 사용자 정보 수정<a class="btn btn-success" href="admin.php" style="margin-left: 850px"><span class="glyphicon glyphicon-home"></span>&nbsp; Back</a></h1>
        <hr>
    </div>
        ...
        <table class="table table-responsive">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <input id="pw" class="form-control" type="password" name="<? echo $r2; ?>" value="<?php echo $decrypted_password; ?>" placeholder="패스워드를 입력하세요." autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" required />
            ...
            <tr>
                ...
                <td>
                    <input class="form-control" type="text" name="<? echo $r3; ?>" value="<?php echo $userprofile; ?>" placeholder="프로필을 입력하세요." autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" required />
